  ...
  useEffect(() => {
    const loadProfile = async () => {
      try {
        ...
        const laureatProfile = await ProfileService.getLaureatProfile(currentUser.id);

        // Récupération des spécialités
        const specsRes = await fetch('/api/specialites/');
        ...
        // Récupérer les IDs actuels depuis l’utilisateur (ou depuis le profil)
        setSelectedSpecialiteId(currentUser.specialite || null);
        setSelectedCountryId(currentUser.country || null);
