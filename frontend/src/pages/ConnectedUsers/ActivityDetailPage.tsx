...
const ActivityDetailPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Restaurer l'utilisateur depuis l'API si le cache mémoire est vide (après refresh)
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      // Re-fetcher l'activité pour avoir le vrai nombre de participants
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="relative h-64 md:h-80 bg-gray-200">
        ...
        {/* Category Badge */}
        <span className={`absolute top-4 right-4 px-4 py-1.5 text-white text-sm font-medium rounded-full ${getCategoryColor(activity.category)}`}>
            ...
            <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-lg">
              ...
              <div>
                ...
                <p className="font-medium text-gray-800">
                  {activity.event_date ? formatDate(activity.event_date) : 'À définir'}
                </p>
              </div>
            </div>
