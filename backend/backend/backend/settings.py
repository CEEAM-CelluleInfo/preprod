...
INSTALLED_APPS = [
    ...
    'whitenoise.runserver_nostatic',  # Pour servir les fichiers statiques en production sans config supplémentaire
     # Third-party
    'rest_framework',
...
PREVIEW_FRONTEND_ORIGIN_REGEXES = [
    r'^https://[a-z0-9-]+\.pages\.dev$',
]

PREVIEW_FRONTEND_CSRF_ORIGINS = [
    'https://*.pages.dev',
]
...
CORS_ALLOWED_ORIGIN_REGEXES = PREVIEW_FRONTEND_ORIGIN_REGEXES
...
if DEBUG:
    CSRF_TRUSTED_ORIGINS = BACKEND_ORIGINS + FRONTEND_ORIGINS + PREVIEW_FRONTEND_CSRF_ORIGINS + LOCAL_DEV_ORIGINS
else:
    CSRF_TRUSTED_ORIGINS = BACKEND_ORIGINS + FRONTEND_ORIGINS + PREVIEW_FRONTEND_CSRF_ORIGINS
